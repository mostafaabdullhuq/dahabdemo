...
export const toasterInterceptor: HttpInterceptorFn = (req, next) => {
  ...
  const excludedUrls = ['login', 'expenses-chart', 'liabilities-chart', 'revenue-chart', 'assets-chart', 'customer-orders', 'shift-status', 'business-custom-fields', 'order-product-receipt', 'order-product-update', 'currencies', 'gold-price', 'branch', 'currencies', 'payment-method'];
